...
import br.edu.utfpr.pb.carlos.soster.oo24s.model.AbstractModel;
import br.edu.utfpr.pb.carlos.soster.oo24s.util.EntityManagerUtil;
...
public abstract class GenericDao<T extends AbstractModel, I extends Serializable> {
    ...
    @PersistenceContext(unitName = "TrabalhoFinal-CarlosSoster")
